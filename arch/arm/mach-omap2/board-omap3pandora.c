 ...
 *
 * Modified from mach-omap2/board-omap3evm.c and mach-omap2/board-omap3beagle.c
 *
 * Initial Pandora code: John Willis
 *
...
static int __init omap3_pandora_i2c_init(void)
{
...
arch_initcall(omap3_pandora_i2c_init);
...
MACHINE_START(OMAP3_PANDORA, "OMAP3 Pandora Handheld Console")
